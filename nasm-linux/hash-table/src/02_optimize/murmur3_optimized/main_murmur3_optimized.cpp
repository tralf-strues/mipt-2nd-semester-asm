...
int main()
{
    ...
    HashTable hashTable = {};
    construct(&hashTable, HASH_TABLE_SIZE, strcmp, (uint32_t (*) (ht_key_t key)) getOPCrc32Hash); 
...
// extern uint32_t getMurmur3HashOP (const char* string);
// const char**    readWords        (char** buffer);
// void            testInsertions   (HashTable* hashTable, const char** words);
// void            testSearches     (HashTable* hashTable, const char** words);
