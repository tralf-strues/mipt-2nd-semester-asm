...
set term svg dynamic size 5000 2000 background rgb "white"
set key title "Standard deviation = 2.29468" font ",40" offset 0, -3
set output "res/00_compare_hashes/size_1031/gnuplot_test_output9.svg"
set title "CRC32 optimized hash function"
plot "res/00_compare_hashes/size_1031/plot_data.dat" using 1:2 index 8 with boxes ls 1

set term svg dynamic size 5000 2000 background rgb "white"
set key title "Standard deviation = 2.40784" font ",40" offset 0, -3
set output "res/00_compare_hashes/size_1031/gnuplot_test_output10.svg"
set title "Polynomial hash function"
plot "res/00_compare_hashes/size_1031/plot_data.dat" using 1:2 index 9 with boxes ls 1

set term svg dynamic size 5000 2000 background rgb "white"
set key title "Standard deviation = 2.33682" font ",40" offset 0, -3
set output "res/00_compare_hashes/size_1031/gnuplot_test_output11.svg"
set title "Polynomial optimized hash function"
plot "res/00_compare_hashes/size_1031/plot_data.dat" using 1:2 index 10 with boxes ls 1
